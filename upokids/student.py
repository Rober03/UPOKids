...
class student(osv.Model):
    ...
    _columns = {
            ...
            'upokidsclass_ids':fields.many2many('upokidsclass', 'student_class_rel', 'student_id', 'class_id', 'Classes'),
            'payment_ids': fields.one2many('payment','student_id', 'Payments', readonly=False),
